<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Assicurati che la nuova Password rispetti i criteri di sicurezza.') }}
        </p>
    </header>

    <form method="post" action="{{ route('password.update_admin') }}" class="mt-6 space-y-6">
        @csrf
        @method('put')
